...
test.describe('@smoke @api API health', () => {
...
test.describe('@smoke @api @finance Finance API smoke', () => {
...
test.describe('@smoke @api @commerce Commerce API smoke', () => {
